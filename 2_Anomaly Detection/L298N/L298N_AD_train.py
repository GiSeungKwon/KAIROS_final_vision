...
NUM_EPOCHS = 20
IMAGE_SIZE = 128
DATA_DIR = "../../../data/ObjectClassification/Aug_L298N"
# 최적 모델 저장 경로 (기존 유지)
MODEL_SAVE_PATH_BEST = 'L298N_anomaly_detector_best_loss.pth' 
# 주기적 백업 모델 저장 경로 (새로 추가, 포맷 문자열로 사용)
MODEL_SAVE_PATH_PERIODIC = 'L298N_anomaly_detector_epoch_{:03d}.pth' 
...
print(f"로드된 L298N 정상 이미지 수: {len(dataset)}")
